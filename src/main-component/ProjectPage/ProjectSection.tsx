...
const PROJECTS = [
  ...
  },
  {
    ...
    title: "ConvoAI Chatbot Suite",
    desc: "An intelligent customer support platform with NLP-powered chatbots, sentiment analysis, and automated ticket routing. Node.js and Express handle real-time messaging; MongoDB stores conversation history and training data for continuous model improvement.",
    industry: "AI & Automation",
    country: "Canada",
    techs: ["nextjs", "typescript", "nodejs", "express", "mongodb", "mongoose"] as TechKey[],
  },
  {
    img: "https://images.unsplash.com/photo-1555949963-aa79dcee981c?auto=format&fit=crop&w=1600&q=80",
    title: "VisionInspect Quality AI",
    desc: "A computer vision system for automated product inspection on manufacturing lines. TypeScript and Next.js power the monitoring dashboard; Express APIs process image data and PostgreSQL with Prisma stores defect logs and audit trails.",
    industry: "Manufacturing & QA",
    country: "Germany",
    techs: ["nextjs", "typescript", "express", "postgresql", "prisma"] as TechKey[],
  },
];
...
const ProjectSection: React.FC = () => {
  useEffect(() => {
    const bgElement = document.querySelector<HTMLElement>(".project-page-listing.bg_img");
    if (bgElement) {
      bgElement.style.backgroundImage = `url(${projectBg})`;
    }

    const items = document.querySelectorAll<HTMLElement>(".project-page-listing .xb-project-item");
    const paginations = document.querySelectorAll<HTMLElement>(".project-page-listing .xb-project-pagination li");
  ...
  return (
    <section className="project project-page-listing bg_img pt-80 pb-150">
